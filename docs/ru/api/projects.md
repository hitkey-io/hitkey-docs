...
::: warning Контроль доступа
- **Owner** может менять роль и разрешения любого участника (для себя — только разрешения)
- **Admin** может редактировать только разрешения обычных участников и свои собственные
- Никто не может изменить свою роль или роль владельца
:::
...
|------|--------|----------|
| 403 | `ADMIN_CANNOT_EDIT_ADMIN` | Админ не может редактировать другого админа |
| 403 | Cannot change your own role | Нельзя изменить свою роль |
| 400 | Cannot change owner role | Роль владельца нельзя изменить |
| 403 | Only owner can assign admin role | Только владелец может назначить роль админа |
