...
::: warning Назорати дастрасӣ
- **Owner** метавонад нақш ва иҷозатҳои ҳар як аъзоро иваз кунад (барои худ — танҳо иҷозатҳо)
- **Admin** танҳо иҷозатҳои аъзоёни оддӣ ва худро таҳрир карда метавонад
- Ҳеҷ кас наметавонад нақши худ ё нақши соҳибро иваз кунад
:::
...
| HTTP | Хато | Тавсиф |
|------|------|--------|
| 403 | `ADMIN_CANNOT_EDIT_ADMIN` | Админ наметавонад иҷозатҳои админи дигарро таҳрир кунад |
| 403 | Cannot change your own role | Корбарон наметавонанд нақши худро иваз кунанд |
| 400 | Cannot change owner role | Нақши соҳибро иваз кардан мумкин нест |
| 403 | Only owner can assign admin role | Танҳо соҳиб метавонад аъзоёнро ба админ баланд барад |
